...
const CommunityPostDetail: NextPage = () => {
    return (
        <Layout title='동네생활' hasTabBar>
            <div>
                <span
                    className={`inline-flex my-2.5 ml-4 items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800`}
                >
                    동네질문
                </span>
                ...
                <div className={`px-4`}>
                    ...
                    />
                    <button
                        className='mt-2 w-full bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium focus:ring-2 focus:offset-2 focus:ring-orange-500 focus:outline-none'>
                        Reply
                    </button>
                </div>
            </div>
